...
select 'ca1ca31c-9001-49c7-833a-52ae51e55cde', 'ing',
  ...
  'Cuando la descripción empieza con «do this», busca un verbo entre las opciones, no un objeto.', 'publicada', 'modelo', '1a44858a38935381753917e7a879bd1b', null;
...
select 'e183dfb1-7b32-4e4d-bb50-2d0a3ab5f594', 'ing',
  ...
  array['boat', 'fish', 'drive', 'island', 'ride', 'roller skates', 'swimming pool', 'tennis'],
  'La palabra place te avisa de que la respuesta es un lugar. Descarta de entrada los verbos y los objetos.', 'publicada', 'modelo', '99a292a107eee6e42609a50c914d2bf6', null;
...
select '209dd482-ee2d-4077-bcd0-ec5effa21b32', 'ing',
  ...
  array['boat', 'fish', 'drive', 'island', 'ride', 'roller skates', 'swimming pool', 'tennis'],
  'Varias palabras del inglés son verbo y sustantivo a la vez. Fíjate en si la frase pide una acción o una cosa.', 'publicada', 'modelo', '9415600dc8d3f08691589349cdcceeab', null;
...
select 'e61b7078-5a9b-4361-880f-ca78c3fa8f5c', 'ing',
  ...
  array['boat', 'fish', 'drive', 'island', 'ride', 'roller skates', 'swimming pool', 'tennis'],
  'El pronombre it apunta a una sola cosa concreta; si dijera them, la respuesta sería un plural.', 'publicada', 'modelo', '3fb200b63f9001c5993cf7f22f559b3a', null;
...
select 'afebc77d-ff22-425a-b1cc-341e258d92f1', 'ing',
  ...
  array['boat', 'fish', 'drive', 'island', 'ride', 'roller skates', 'swimming pool', 'tennis'],
  'La estructura «put them on» significa ponerse algo encima: ropa, zapatos o, como aquí, patines.', 'publicada', 'modelo', '3c522d08dafb06672f53fb273550f9b4', null;
...
select '76c222a6-18f7-4333-9ea8-0fe3a1488a8e', 'ing',
  ...
  'Below significa debajo. Ubica primero la posición que describe la frase y después busca el espacio que le corresponde.', 'publicada', 'modelo', '0f1992f569a921915850201bc9065841', null;
...
select 'b4ec0283-805d-47b7-95e1-36d7fbe44063', 'ing',
  ...
  array['Basement', 'Chair', 'Picture', 'Sofa', 'Stairs', 'Table', 'Towel', 'Radio'],
  'La palabra photo te dice que la respuesta es algo que se mira, no algo que se usa.', 'publicada', 'modelo', '9e74a6a49d209a1fce16608bff35b680', null;
...
select 'e0cedb95-ff8a-4340-8475-eaeb1c76abc9', 'ing',
  ...
  array['Basement', 'Chair', 'Picture', 'Sofa', 'Stairs', 'Table', 'Towel', 'Radio'],
  'Fíjate en el número: «two or three people» descarta el mueble hecho para una sola persona.', 'publicada', 'modelo', 'c41003ffe3754ac0713d704bcf107822', null;
...
select 'c598ee96-e356-48d7-b492-32deb8e8c1b9', 'ing',
  ...
  array['Basement', 'Chair', 'Picture', 'Sofa', 'Stairs', 'Table', 'Towel', 'Radio'],
  'El verbo dry es secar. Piensa qué objeto de la casa cumple justo esa función.', 'publicada', 'modelo', '5f3ff9fac935b8e9b279b17a1a41c2c6', null;
...
select '6d10722b-4dee-47fb-84ce-1d534ea6f3de', 'ing',
  ...
  array['Basement', 'Chair', 'Picture', 'Sofa', 'Stairs', 'Table', 'Towel', 'Radio'],
  'Up or down describe un movimiento vertical: en una casa eso solo lo permite un elemento.', 'publicada', 'modelo', '593f6701c452543813b46c1d15ff01ae', null;
...
select 'ee7c91c1-9461-42b4-b257-94c714b13d3f', 'ing',
  ...
  'La misma pista de siempre: «put them on» significa ponerse algo, así que la respuesta se lleva puesta.', 'publicada', 'modelo', '5119efe38c7e903b8cbbb07246d66ff7', null;
...
select '7b648e91-e977-4ed5-9dfd-accb08a083ee', 'ing',
  ...
  array['baseball', 'basketball', 'boats', 'cars', 'field', 'pool', 'skates', 'tennis'],
  'Cuenta cuántos jugadores menciona la frase: ese dato suele separar un deporte de otro parecido.', 'publicada', 'modelo', '8a4ec881d7c89e957687897e51ef2065', null;
...
select 'b1b75915-9756-4f5e-847f-02e4bbee69d8', 'ing',
  ...
  array['baseball', 'basketball', 'boats', 'cars', 'field', 'pool', 'skates', 'tennis'],
  'Swim es nadar. Entre las opciones busca el único lugar hecho para el agua.', 'publicada', 'modelo', 'c2d09b8a02a7ad277a13b4153a0f0bbd', null;
...
select '96a2b8e5-978b-4157-b4e0-f4cc83f04b96', 'ing',
  ...
  array['baseball', 'basketball', 'boats', 'cars', 'field', 'pool', 'skates', 'tennis'],
  'Dos datos definen el deporte: el tamaño del balón y con qué parte del cuerpo se juega.', 'publicada', 'modelo', 'a16618f1d38430ef819bf7e10ef26184', null;
...
select '1fd2674d-6791-4187-8bc6-cbc374e7c034', 'ing',
  ...
  array['baseball', 'basketball', 'boats', 'cars', 'field', 'pool', 'skates', 'tennis'],
  'Cada vehículo tiene su verbo en inglés: drive para carros, sail para botes, ride para bicicletas.', 'publicada', 'modelo', 'f4fb889775cd64feaffc31705c93c37c', null;
...
select '912601d9-02f0-480d-b811-8eb615e4945b', 'ing',
  ...
  'La palabra vegetable ya reduce la lista. Después usa el color y la forma para escoger.', 'publicada', 'modelo', '804e00689399efa10eaa7ade02c1039e', null;
...
select 'ac3d70cb-c7e6-4a5c-b4bc-cfde30aeeca3', 'ing',
  ...
  array['candy', 'carrot', 'chicken', 'fish', 'milk', 'soup', 'tea', 'apple'],
  'Fíjate en los ingredientes que enumera la frase: el plato tiene que contenerlos todos.', 'publicada', 'modelo', '2fa3e2320d43e34498b259384d104fd1', null;
...
select '3c0a1b2c-c098-4a10-a98b-2c551cb22f58', 'ing',
  ...
  array['candy', 'carrot', 'chicken', 'fish', 'milk', 'soup', 'tea', 'apple'],
  'Cuando la frase da dos pistas (de dónde viene y para qué sirve), la respuesta debe cumplir las dos.', 'publicada', 'modelo', '8cbd4a13f6192a82bd4fd8a04616c71a', null;
...
select '00315c20-e942-4305-892d-9a48d4caeb59', 'ing',
  ...
  array['candy', 'carrot', 'chicken', 'fish', 'milk', 'soup', 'tea', 'apple'],
  'Sweet es dulce. Recorre la lista y quédate con lo único que sea azucarado.', 'publicada', 'modelo', '0a71eb71c93c6a8c4d3d80c30febcb51', null;
...
select 'd41286e9-30bf-4e82-884f-f3a13e41f6b1', 'ing',
  ...
  array['candy', 'carrot', 'chicken', 'fish', 'milk', 'soup', 'tea', 'apple'],
  'Aquí «fish» es el animal, no la acción de pescar. El contexto de cada bloque cambia el sentido de la palabra.', 'publicada', 'modelo', 'f1cd0a32c5a6972f41e506d1f5ac1be0', null;
...
select '57941805-cb5f-42b5-b5a3-5fe1f5a9ab3c', 'ing',
  ...
  'La frase dice «to drink»: busca la fruta que guarda líquido, no la que tiene jugo al exprimirla.', 'publicada', 'modelo', '5286ffc855f198c8d74ff56b859dffc0', null;
...
select '084f6044-036a-42ee-aa31-491a90ae503b', 'ing',
  ...
  array['Banana', 'Coconut', 'Grape', 'Lime', 'Mango', 'Pear', 'Pineapple', 'Watermelon'],
  'Cuando la descripción une forma y un animal conocido, casi siempre apunta a una fruta muy familiar.', 'publicada', 'modelo', '755d4152f87634b47fd3690efa98593c', null;
...
select 'bef6d5af-d876-4e2c-a02b-315debf1f9f7', 'ing',
  ...
  array['Banana', 'Coconut', 'Grape', 'Lime', 'Mango', 'Pear', 'Pineapple', 'Watermelon'],
  'Inside indica el interior de la fruta, no su cáscara. Imagínala partida por la mitad.', 'publicada', 'modelo', '0366ad7a18c20bbecf99651a3697d58c', null;
...
select 'ff9ff8de-42b8-4b72-9a98-37330e3b6dfa', 'ing',
  ...
  array['Banana', 'Coconut', 'Grape', 'Lime', 'Mango', 'Pear', 'Pineapple', 'Watermelon'],
  'Juice aquí no es una bebida: es el jugo que se exprime encima de otra comida.', 'publicada', 'modelo', 'cafc08d4a18da6e9a6213faa7d7bafe2', null;
...
select '0be89c38-e6f2-4ed8-a10f-23ee82b6feaa', 'ing',
  ...
  array['Banana', 'Coconut', 'Grape', 'Lime', 'Mango', 'Pear', 'Pineapple', 'Watermelon'],
  'Dos datos juntos, tamaño y color, suelen dejar una sola fruta posible.', 'publicada', 'modelo', '9c8845786908a6a30efcec868d477993', null;
