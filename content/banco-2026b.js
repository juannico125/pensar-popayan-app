...
const BANKS = {
  lc: [
    ...
    },
    {
      ...
      correct: 0,
      exp: 'El texto dice que los cargueros heredan el oficio «de sus padres y abuelos», que es un honor «que no se compra ni se vende» y que el valor reside «en aquello que no cambia». De esas tres pistas se infiere que lo que valoran es la continuidad heredada. Las alternativas que apelan al turismo o a la modernización contradicen su postura, y la del reconocimiento económico choca con el «no se compra ni se vende».',
    ...
    },
    {
      ...
      correct: 0,
      exp: 'El argumento central es que los páramos son valiosos porque de ellos depende cerca del 70 % del agua de las ciudades andinas. Si esa agua viniera en realidad de acuíferos ajenos al páramo, el argumento perdería su base. Las demás alternativas repiten datos que el propio texto ya trae, o lo refuerzan en vez de debilitarlo.',
    ...
    },
    {
      ...
      correct: 0,
      exp: '«Insustituible» significa que no tiene sustituto: el autor afirma que la lectura profunda, la que forma criterio propio, no puede ser reemplazada por la lectura fragmentada. No dice que vaya a desaparecer, ni la compara por entretenimiento, ni la limita al papel impreso.',
    ...
    },
    {
      ...
      correct: 0,
      exp: '«Quienes vienen detrás» son las generaciones futuras; hablar de la ciudad que se les «deja» apela a la responsabilidad hacia ellas. No evoca nostalgia, ni menciona ahorro, ni una obligación legal: el llamado es ético, no jurídico.',
  ...
  mat: [
    {
      ...
      opts: ['60', '55', '70', '90'],
      correct: 0,
      exp: 'Se suman las ventas de los cinco días: 40 + 55 + 45 + 70 + 90 = 300, y se divide entre 5: 300 ÷ 5 = 60. Cuidado con los distractores clásicos: 55 es la mediana, no el promedio, y 90 es el valor máximo.',
    ...
    },
    {
      ...
      correct: 0,
      exp: 'Los casos favorables son las mujeres del sabatino: 12. Los casos posibles son todos los estudiantes: 40. La probabilidad es 12/40 = 3/10. Cuidado: 12/22 sería la probabilidad de ser del sabatino DADO que es mujer (condicional), y 11/20 la de ser mujer de cualquier jornada.',
    ...
    },
    {
      ...
      correct: 0,
      exp: 'El sendero quita 2 m por CADA lado: el jardín mide (12 − 2 − 2) × (8 − 2 − 2) = 8 × 4 = 32 m². Cuidado: 96 m² es el área total del lote, y 60 m² resulta de restar los 2 m una sola vez por dimensión, que es el error más común.',
    ...
    },
    {
      ...
      correct: 0,
      exp: 'Con 25 % de descuento se paga el 75 % del precio: 0,75 × 12.000 = $9.000 por cuaderno. Por cuatro cuadernos: 4 × 9.000 = $36.000. Cuidado: $48.000 es el precio sin descuento y $9.000 es lo que cuesta un solo cuaderno.',
    ...
    },
    {
      ...
      opts: ['11', '22', '16', '33'],
      correct: 0,
      exp: 'Si hay h hombres, hay 2h mujeres. En total: h + 2h = 33 → 3h = 33 → h = 11. Entonces hay 11 hombres y 22 mujeres. Cuidado: 22 es el número de mujeres, no el de hombres.',
    ...
    },
    {
      ...
      correct: 0,
      exp: 'Cercar el contorno es hallar el perímetro: P = 2 × (largo + ancho) = 2 × (40 + 20) = 2 × 60 = 120 m. Cuidado: 800 corresponde al área (40 × 20), no al perímetro, y va en unidades distintas (m²).',
